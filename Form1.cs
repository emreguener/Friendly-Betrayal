...
namespace Friendly_Betrayal
{
    public partial class Form1 : Form
    {
        ...
        // Kullanıcıların puanlarını 10 tur tutmak için tanımlandı.
        ...
        {
            rnk.Text = ($"User1 Points: {User1_Point}\nUser2 Points: {User2_Point}\nUser3 Points: {User3_Point}\nUser4 Points: {User4_Point}");
        }

        private void rest_Click(object sender, EventArgs e)
        {
            // Tüm oyuncu kartlarını temizle
            cmb_Box1.Items.Clear();
            cmb_Box2.Items.Clear();
            cmb_Box3.Items.Clear();
            cmb_Box4.Items.Clear();

            // Ortaya açılan ve atılan kartları temizle
            revealedCards.Items.Clear();
            discardedCards.Items.Clear();

            // Betrayal kart listelerini temizle
            BetrayalCards1.Items.Clear();
            BetrayalCards2.Items.Clear();
            BetrayalCards3.Items.Clear();
            BetrayalCards4.Items.Clear();

            // Diğer oyun durum değişkenlerini sıfırla
            first_tour = false;
            remaining = 52;
            currentCardIndex = 0;
            ...
            // Oyun başı UI güncellemeleri
            label1.Text = "Dağıtılan Kart Sayısı: 0";
            label2.Text = "Tur Sayısı: 0";
            rnk.Text = "Puanlar sıfırlandı.";
            trn.Text = "Turn: User1";
            ...
            // Deal butonunu tekrar aktif hale getir
            btn_deal.Enabled = true;
